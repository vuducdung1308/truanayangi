...
// thousands of VND (200k–400k). `sub` names the venue + area; `image` reuses the
// existing lunch atlas so every dish shows a real photo.
...
const entries: FridayEntry[] = [
  ...
  { name: 'Lẩu băng chuyền cá nhân', sub: 'Kichi-Kichi • Vincom Bà Triệu', price: 230, image: 71, quip: 'Đĩa cứ chạy, tay cứ gắp.' },
  ...
  { name: 'Set nướng bò Mỹ', sub: 'Gogi House • Vincom Bà Triệu', price: 260, image: 65, quip: 'Nướng xèo xèo, thứ 6 đúng nghĩa.' },
